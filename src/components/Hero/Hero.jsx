...
const ImageList=[
    {
        ...
        description: "Grab up to 50% off on all men's wear - style meets savings!",
    },
    {
        id: 2,
        img: Image2,
        title: "30% off on all Women's Wear",
        description: "Celebrate style with 30% off on all Women's Wear - limited time only!",
    },
    {
        id: 3,
        img: Image3,
        title: "70% off on all Products Sale",
        description: "Don't miss out! Get 70% off on all products—limited time only!",
    },
                  ...
                  <div>
                     ...
                     {/* text content section   */}
                         ...
                         <div data-aos="fade-up" data-aos-duration="500" data-aos-delay="300">
                             <button className="bg-gradient-to-r from-primary to-secondary hover:scale-105 duration-200 text-white py-2 px-4 rounded-full mx-1" onClick={handleOrderPopup}>
                             Order Now
                             </button>
                         </div>
                         </div>
